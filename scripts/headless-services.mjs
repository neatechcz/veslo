...
export async function startHeadlessServices({
  fakeMode = "success",
  profile,
  aiGatewayBaseUrl,
  queueDrainPollMs,
  ...
  const environment = {
    ...
    ...(Number.isFinite(queueDrainPollMs) && queueDrainPollMs > 0
      ? { VESLO_SERVICE_TEST_QUEUE_DRAIN_POLL_MS: String(queueDrainPollMs) }
      : {}),
