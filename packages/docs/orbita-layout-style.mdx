...
description: "Distilled reference for the three-pane Veslo session layout"
---

This style document distills the new Orbita session UI into reusable Veslo patterns.
