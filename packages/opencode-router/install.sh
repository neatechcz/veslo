...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/neatechcz/veslo.git}"
OPENCODE_ROUTER_INSTALL_DIR="${OPENCODE_ROUTER_INSTALL_DIR:-$HOME/.veslo/opencode-router/veslo}"
...
Environment variables:
  OPENCODE_ROUTER_INSTALL_DIR  Install directory (default: ~/.veslo/opencode-router/veslo)
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/neatechcz/veslo.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/neatechcz/veslo/dev/packages/opencode-router/install.sh | bash
EOF
}
...
if [[ "$OPENCODE_ROUTER_INSTALL_METHOD" == "npm" ]]; then
  require_bin npm
  echo "Installing veslo-code-router via npm..."
