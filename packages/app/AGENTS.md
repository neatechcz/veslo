...
- Before changing prompt send, session creation, workspace switching, or Veslo server client calls, read `docs/dev/opencode-workspace-runtime-architecture.md`. The app sends intent; it must not choose OpenCode session ids or directories directly.
