...
export default function CreateRemoteWorkspaceModal(props: {
  ...
  const canSubmit = createMemo(() => {
    ...
    return vesloHostUrl().trim().length > 0;
  });
      ...
      <div class="p-6 flex-1 overflow-y-auto space-y-6">
        ...
        <div class="space-y-4">
          <TextInput
            ...
            value={vesloHostUrl()}
            onInput={(event) => setVesloHostUrl(event.currentTarget.value)}
      ...
      <div class="p-6 border-t border-gray-6 bg-gray-1 space-y-3">
        ...
        <div class="flex justify-end gap-3">
          ...
          <Button
            ...
            disabled={!canSubmit()}
            title={!vesloHostUrl().trim() ? translate("dashboard.remote_base_url_required") : undefined}
          >
            {confirmLabel()}
          </Button>
        </div>
