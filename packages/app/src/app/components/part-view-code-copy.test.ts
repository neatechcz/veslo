...
const markdownRenderer = readFileSync(new URL("./part-view-markdown-renderer.ts", import.meta.url), "utf8");
...
test("markdown renderer outputs a copy button for text-labeled code blocks", () => {
