...
export function createVesloServerClient(options: {
  ...
  return {
    ...
    retryTerminalHandoff: conversations.retryTerminalHandoff,
    ...
    requestControlPlaneRebind: workspace.requestControlPlaneRebind,
    beginRuntimeOperation: workspace.beginRuntimeOperation,
    completeRuntimeOperation: workspace.completeRuntimeOperation,
