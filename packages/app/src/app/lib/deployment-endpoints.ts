...
export function readViteDeploymentDomain(
  env: Record<string, string | undefined> | undefined = typeof import.meta !== "undefined"
    ? (import.meta as { env?: Record<string, string | undefined> }).env
    : undefined,
): string | null {
  return env?.VITE_VESLO_DEPLOYMENT_DOMAIN?.trim() || null;
}
