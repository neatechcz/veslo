...
- `AGENTS.md` (and `_repos/veslo/AGENTS.md` if it exists)
...
1) `.opencode/commands/soul-heartbeat.md`
   ...
   2) Read `AGENTS.md` (and `_repos/veslo/AGENTS.md` if present).
