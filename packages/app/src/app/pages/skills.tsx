      ...
      <div class="rounded-2xl border border-dls-border bg-dls-surface px-5 py-5 shadow-[0_8px_26px_rgba(17,24,39,0.05)]">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div class="min-w-0 space-y-1">
            <div class="font-product type-ui-xs font-semibold uppercase tracking-[0.18em] text-dls-secondary">{translate("skills.worker_profile")}</div>
            <div class="font-product type-title-sm text-dls-text truncate">{workspaceLabel()}</div>
            <p class="font-reading type-ui-md text-dls-secondary">
        ...
        <div class="mt-4 grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <div class="rounded-lg border border-dls-border bg-dls-hover px-3 py-2.5">
            <div class="font-product type-ui-xs text-dls-secondary">{translate("skills.stat_skill_creator")}</div>
            <div class="font-product type-ui-md mt-1 font-semibold text-dls-text">
              {skillCreatorInstalled() ? translate("skills.stat_installed") : translate("skills.stat_not_installed")}
            </div>
          </div>
          <div class="rounded-lg border border-dls-border bg-dls-hover px-3 py-2.5">
            <div class="font-product type-ui-xs text-dls-secondary">{translate("skills.stat_mode")}</div>
            <div class="font-product type-ui-md mt-1 font-semibold text-dls-text">
