...
const appSourceContractInventory: AppSourceContractInventoryEntry[] = [
  ...
  { path: "app-send-prompt-session-creation.test.ts", classification: "behavior", retargetBy: "AM11/AM12" },
  { path: "app-send-workspace-scope.test.ts", classification: "behavior", retargetBy: "AM11" },
  { path: "app-session-archives.test.ts", classification: "behavior", retargetBy: "AM14" },
  ...
  { path: "app-stale-local-runtime-recovery.test.ts", classification: "behavior", retargetBy: "AM11" },
  ...
  {
    path: "components/session/composer-screenshot-staging-regression.test.ts",
  ...
  { path: "pending-session-send-flow.test.ts", classification: "behavior", retargetBy: "AM11" },
