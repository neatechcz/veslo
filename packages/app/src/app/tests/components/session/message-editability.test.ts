...
import { getEditableUserMessageDraft } from "../../../components/session/message-editability";
...
test("non-image data file attachments with inline path prose still block editing", () => {
  const result = getEditableUserMessageDraft({
    messages: [
      message("m1", "user", [
        textPart("m1", "please review session/brief.docx"),
        dataFilePart(
          "m1",
          "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
          "brief.docx",
