...
} from "../../../components/session/workspace-session-list-prefs.js";

const source = readFileSync(new URL("../../../components/session/workspace-session-list-prefs.ts", import.meta.url), "utf8");
