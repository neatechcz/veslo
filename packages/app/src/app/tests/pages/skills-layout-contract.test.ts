...
const source = readFileSync(new URL("../../pages/skills.tsx", import.meta.url), "utf8");
...
test("inventory remove actions use target-aware remove and restore helpers", () => {
  const removeHelperSource = source.slice(
    ...
    source.indexOf("const restoreTargetForInstance", source.indexOf("const removeTargetForInstance")),
  );
