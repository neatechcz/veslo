...
export default {
  ...
  "skills.install_target_all_workspaces": "All workspaces",
  ...
  "skills.detail_tab_sharing": "Sharing",
  ...
  "skills.detail_copy_to_global": "Copy to global",
  "skills.detail_move": "Move",
  "skills.detail_move_to_global": "Move to global",
  ...
  "skills.detail_scope_global": "Global",
  ...
  "skills.review_organization_publish_description": "Creates a request to publish this skill version into the organization catalog. It does not change the local runtime until registry publishing is connected.",
  ...
  "skills.review_request_organization_publish": "Request organization publish",
  ...
  "skills.uninstall_read_only": "Managed or read-only skill locations cannot be uninstalled locally yet.",
  "skills.uninstall_scope_ambiguous": "Uninstall from the exact skill scope is not available yet.",
  "skills.uninstall_not_active_workspace": "Switch to this workspace before uninstalling this skill.",
  "skills.uninstall_desktop_required": "Uninstall requires the desktop app.",
  "skills.uninstall_scoped_pending": "Scoped uninstall is not available yet.",
  ...
  "skills.share_description": "Publish a public link. Anyone with the URL can install this skill.",
  ...
  "skills.failed_copy_link": "Failed to copy link",
  "skills.filter_scope": "Scope",
  "skills.filter_scope_all": "All scopes",
  "skills.filter_scope_global": "Global",
  ...
  "skills.copy_to_global": "Copy to global",
  "skills.move_to_global": "Move to global",
  "skills.copy_to_global_unavailable": "Select writable skills from the current workspace to copy them to global.",
  "skills.copy_to_global_read_only": "Managed or read-only skills cannot be copied or moved locally yet.",
  "skills.copy_to_global_already_global": "This skill is already available in all workspaces.",
  "skills.copy_to_global_not_active_workspace": "Switch to this workspace before copying or moving this skill to global.",
  "skills.copied_to_global": "Skill copied to global.",
  "skills.moved_to_global": "Skill moved to global.",
  "skills.bulk_publish": "Publish",
  "skills.bulk_adopt": "Adopt",
  "skills.bulk_remove": "Remove",
