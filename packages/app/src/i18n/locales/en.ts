...
export default {
  ...
  "skills.review_valid_package": "Ready for review",
  ...
  "skills.review_precondition_metadata": "Metadata is filled in.",
  "skills.review_precondition_skill_file": "The package includes SKILL.md.",
  "skills.review_precondition_name_conflicts": "Name-conflict review is ready.",
  ...
  "skills.review_footer_unavailable": "Without a connected catalog, this action is saved only as a draft.",
