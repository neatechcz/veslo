...
export default {
  ...
  "skills.uninstall": "停用",
  "skills.uninstall_title": "停用 skill？",
  ...
  "skills.uninstall_failed": "停用 skill 失败。",
  "skills.uninstall_read_only": "只读 skill 位置暂不能在本地停用。",
  "skills.uninstall_scope_ambiguous": "暂不支持停用此精确 skill 范围。",
  "skills.uninstall_not_active_workspace": "请先切换到此工作区，再停用此 skill。",
  "skills.uninstall_desktop_required": "停用需要桌面应用。",
  "skills.uninstall_scoped_pending": "暂不支持按精确范围停用。",
  "skills.uninstalled": "Skill 已停用。",
  ...
  "skills.bulk_removed_actions_unavailable": "已移除 skills 不支持转移动作。",
