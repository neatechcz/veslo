...
export default {
  ...
  "skills.install_target_all_workspaces": "所有工作区",
  ...
  "skills.detail_copy_to_global": "复制到全局",
  "skills.detail_move": "移动",
  "skills.detail_move_to_global": "移动到全局",
  ...
  "skills.review_organization_publish_description": "创建将此 skill 版本发布到组织目录的请求。在注册表发布接入前，不会更改本地运行时。",
  "skills.review_system_approval_description": "创建平台审核请求，审核通过后此 skill 版本才能通过系统目录分发。",
  "skills.review_cancel": "取消",
  "skills.review_request_organization_publish": "请求组织发布",
  ...
  "skills.uninstall_read_only": "托管或只读 skill 位置暂不能在本地卸载。",
  ...
  "skills.bulk_copy": "复制",
  "skills.bulk_move": "移动",
  "skills.copy_to_global": "复制到全局",
  "skills.move_to_global": "移动到全局",
  "skills.copy_to_global_unavailable": "请选择当前工作区中可写的 skills 以复制到全局。",
  "skills.copy_to_global_read_only": "托管或只读 skill 暂不能在本地复制或移动。",
  "skills.copy_to_global_already_global": "此 skill 已在所有工作区可用。",
  "skills.copy_to_global_not_active_workspace": "请先切换到此工作区，再将此 skill 复制或移动到全局。",
  "skills.copied_to_global": "Skill 已复制到全局。",
  "skills.moved_to_global": "Skill 已移动到全局。",
  "skills.bulk_publish": "发布",
  "skills.bulk_adopt": "采用",
  "skills.bulk_remove": "移除",
