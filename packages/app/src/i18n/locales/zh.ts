...
export default {
  ...
  "session.target_draft_badge": "草稿",
  "session.target_heading_chat": "添加到聊天",
  "session.target_heading_workspace": "添加到 {name}",
  "session.target_conflict_title": "{name} 中已有草稿",
  "session.target_conflict_description": "切换通信目标前，请选择如何处理。",
  "session.target_conflict_current": "当前文本",
  "session.target_conflict_existing": "{name} 中的草稿",
  "session.target_conflict_use_current": "使用当前文本",
  "session.target_conflict_load_existing": "加载现有草稿",
  "session.target_conflict_escape_hint": "Esc 关闭",
  "session.target_not_available": "通信目标不可用。",
