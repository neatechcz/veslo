...
function setActivePage(page) {
  ...
  const titles = {
    overview: ["Veslo managed AI", "Overview", "Inspect credentials, usage, alerts, users, and audit events from one place."],
    organization: ["Veslo managed AI", "Organization", "Manage organization details, domains, and pending invites."],
    ...
    alerts: ["Veslo managed AI", "Alerts", "Triage credential failures, usage spikes, and routing anomalies."],
